...
<body background="bg4.jpg">
	...
	";
				...
				<ul class="nav nav-tabs pull-right">
					<li><a href="#tab_1" class="btn btn-app" data-toggle="tab"><i class="fa fa-unlock"></i> Dekripsi</a> </li>
				...
				<div class="tab-content">
					<div class="tab-pane" id="tab_1">
						...
						<form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							<div class="form-group has-feedback">
								<input type="text" name="key_deskripsi" id="key_deskripsi" class="form-control" placeholder="Masukan Kunci" required>
								<span class="fa fa-key form-control-feedback"></span>
							</div>
							<label>Masukan gambar (jpeg): </label>
							...
							<div class="row">
								<!-- /.col -->
								<div class="col-xs-12">
									<button type="submit" class="btn btn-primary btn-flat pull-right">Deskripsi &nbsp <i class="fa fa-check"></i></button>
								</div>
								<!-- /.col -->
							</div>
						</form>
					...
					<div class="tab-pane active" id="tab_2">
						...
						<form id="form_stegano" action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							<div class="form-group has-feedback">
								<input type="text" id="key_enskripsi" name="key" class="form-control" placeholder="Masukan Kunci">
								<span class="fa fa-key form-control-feedback"></span>
							</div>
							<div class="form-group has-feedback">
								<textarea id="secret" name="secret" class="form-control" rows=3 placeholder="Masukan Pesan" required></textarea>
								<span class="fa fa-file-text-o form-control-feedback"></span>
							</div>
							<label>Masukan gambar (jpg): </label>
							<div class="input-group" style="margin-bottom:30px">
								<span class="input-group-addon"><i class="fa fa-image"></i></span>
							...
							<div class="row">
								<!-- /.col -->
								<div class="col-xs-12">
									<button type="submit" class="btn btn-primary btn-flat pull-right">Enkripsi &nbsp <i class="fa fa-check"></i></button>
								</div>
								<!-- /.col -->
							</div>
						</form>
